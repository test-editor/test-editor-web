...
import { NAVIGATION_OPEN, EDITOR_CLOSE, EDITOR_DIRTY_CHANGED, EDITOR_ACTIVE, EDITOR_INACTIVE } from '../editor-tabs/event-types';
...
export class UserActivityConfig {
  ...
  events: UserActivityEvent[] = [
    ...
    { name: NAVIGATION_OPEN, activityType: UserActivityType.OPENED_FILE, active: true, elementKey: 'id',
      group: UserActivityConfig.FILE_EDITING_GROUP },
    ...
    { name: EDITOR_DIRTY_CHANGED, activityType: UserActivityType.SELECTED_DIRTY_FILE, active: (payload) => payload.dirty,
      elementKey: 'path', group: UserActivityConfig.FILE_EDITING_GROUP },
    { name: EDITOR_DIRTY_CHANGED, activityType: UserActivityType.SELECTED_FILE, active: (payload) => !payload.dirty, elementKey: 'path',
      group: UserActivityConfig.FILE_EDITING_GROUP },
